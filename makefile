...
all : data.o entry.o table.o message.o table-client.o table-server.o network_client.o table-client table-server test_message.o test_message 
...
network_client.o: $(INCLUDE)network_client-private.h $(INCLUDE)network_client.h $(INCLUDE)inet.h
